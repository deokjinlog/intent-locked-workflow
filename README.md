...
그 다음부터는 **안 칩니다.** 네 단계가 알아서 이어져요. 당신이 하는 건 **"ㅇㅋ" 3번**입니다.
...
**"아니다" 라고 하면** 그 자리에서 고칩니다. 코드는 아직 한 줄도 안 짰으니까요.

> 스킬이 27개지만 **당신이 치는 건 이 하나**입니다. 나머지 26개는 도구가 알아서 부릅니다.
...
**그리고 위가 아래를 묶습니다.** ① 에 *"xlsx 는 범위 밖"* 이라고 박으면 — ② 도 ③ 도 ④ 도 xlsx 를 못 만듭니다. 나중에 ① 이 바뀌면 아래 세 문서가 **자동으로 따라옵니다.**
